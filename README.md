...
## Step 1 - Create and Start an Amazon EC2 Instance <a name="step1"></a>
...
## Step 2 - Connect and Terminate an Amazon EC2 Instance<a name="step2"></a>
...
## Step 4 - Setup a VPC with Public and Private Subnets<a name="step4"></a>
